<nav class="fixed left-0 top-0 z-50 w-full bg-black/50 backdrop-blur-md" x-data="{ open: false }">
	<div class="mx-auto flex items-center justify-between px-4 py-2 sm:px-6 md:px-10">
		...
		<div class="hidden items-center space-x-6 text-sm font-semibold text-white md:flex">
			...
			<a href="#" class="hover:text-yellow-300">Profil Desa</a>
			<a href="#" class="hover:text-yellow-300">Infografis</a>
			<a href="#" class="hover:text-yellow-300">Listing</a>
			<a href="#" class="hover:text-yellow-300">IDM</a>
			<a href="{{ route('news.index') }}" class="hover:text-yellow-300">Berita</a>
	...
	<div x-show="open" x-transition x-cloak
		...
		<a href="#" class="block border-b border-white pb-1">Home</a>
		<a href="#" class="block hover:text-yellow-300">Profil Desa</a>
		<a href="#" class="block hover:text-yellow-300">Infografis</a>
		<a href="#" class="block hover:text-yellow-300">Listing</a>
		<a href="#" class="block hover:text-yellow-300">IDM</a>
		<a href="{{ route('news.index') }}" class="block hover:text-yellow-300">Berita</a>
