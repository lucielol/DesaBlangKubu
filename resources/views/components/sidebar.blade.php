          ...
          <div class="font-medium">
            <button @click="activeSubmenu === 'desa' ? activeSubmenu = '' : activeSubmenu = 'desa'"
              ...
              <svg class="h-4 w-4 transform transition-transform duration-200"
                :class="{ 'rotate-90': activeSubmenu === 'desa' }" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
            ...
            <div x-show="activeSubmenu === 'desa'" x-collapse
              ...
              <a href="{{ route('dashboard.profile.edit') }}"
                class="{{ request()->routeIs('dashboard.profile*') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700' }} flex items-center rounded-lg px-2 py-1 text-sm transition hover:bg-gray-200">
                <i class="fa-solid fa-edit h-5 w-5 me-1.5"></i>
                Profil Desa
              </a>
