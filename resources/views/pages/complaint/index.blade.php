		...
		<table class="min-w-full divide-y divide-gray-200 text-xs sm:text-sm md:table">
			<thead>
				<tr class="bg-gray-100">
					<th class="w-0 border-r border-gray-200 px-4 py-2 text-center text-xs font-medium uppercase text-gray-500">NO</th>
					...
					<th class="border-r border-gray-200 px-4 py-2 text-left text-xs font-medium uppercase text-gray-500">Kategori</th>
			...
			<tbody class="divide-y divide-gray-200 bg-white text-sm">
				...
				@empty
					<tr>
						<td colspan="6" class="border px-3 py-2 text-center">Belum ada pengaduan.</td>
					</tr>
				@endforelse
			</tbody>
		</table>
